...
raiserror('Beginning Instusername_pubs.SQL at %s ....',1,1,@dttm) with nowait

GO

if exists (select * from sysdatabases where name='username_pubs')
begin
  raiserror('Dropping existing username_pubs database ....',0,1)
  DROP database username_pubs
end
GO

raiserror('Creating username_pubs database....',0,1)
go
/*
   Use default size with autogrow
*/

CREATE DATABASE username_pubs
GO
...
if db_name() <> 'username_pubs'
   raiserror('Error in Instusername_pubs.SQL, ''USE username_pubs'' failed!  Killing the SPID now.'
            ,22,127) with log

GO

alter database username_pubs set recovery simple 
GO
...
'This is sample text data for New Moon Books, publisher 0736 in the username_pubs database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the username_pubs database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the username_pubs database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the username_pubs database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the username_pubs database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the username_pubs database. GGG&G is located in München, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the username_pubs database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the username_pubs database. Lucerne publishing is located in Paris, France.
...
declare @dttm varchar(55)
select  @dttm=convert(varchar,getdate(),113)
raiserror('Ending Instusername_pubs.SQL at %s ....',1,1,@dttm) with nowait
