		...
		<div>
			...
			<div>
				Part B: <br/>
					<fieldset><legend>Output Type</legend>
						<label>Sum : <input type="radio" id="sum" name="rbListType" value="rbSum" checked="checked"></label><br/>
						<label>Tabulate : <input type="radio" id="tabulate" name="rbListType" value="rbTabulate"></label><br/>
					</fieldset>
					Seed Number :
					<input size="6" maxlength="6" type="text" id="seedNum"/>&nbsp;
			...
			<div>
				...
				<select name="cSelect">
					...
					<?php echo $partC; // HINT : What might $partC be and where might it be constructed? ?>
				</select>
			</div>
		</div>
		<div class="footer">
