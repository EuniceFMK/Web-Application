...
<head>
    ...
    <title>Eunice De Grace - Home</title>
...
<body>
    ...
    <header>
        <h1>Welcome to Eunice De Grace’s Page </h1>
    </header>

    <nav class="menu">
        <?php
        echo '
        <a href="demos/index.html" class="card">
            <img src="https://geekflare.com/wp-content/uploads/2022/10/demo-video-creators.jpg" alt="Demos">
            <span>Demos</span>
        </a>

        <a href="icas/index.html" class="card">
    ...
    <footer>
        <p>© 2025 — Eunice De Grace Fmukam Ngadjou</p>
    </footer>
