...
namespace ServiceWebICA6.Models;

public partial class Efmukamngadjou1RestaurantDbContext : DbContext
{
    public Efmukamngadjou1RestaurantDbContext()
    {
    }

    public Efmukamngadjou1RestaurantDbContext(DbContextOptions<Efmukamngadjou1RestaurantDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=data.cnt.sast.ca,24680;Database=efmukamngadjou1_RestaurantDB;User Id=efmukamngadjou1;Password=Rachel1980@,.;Encrypt=False;");
